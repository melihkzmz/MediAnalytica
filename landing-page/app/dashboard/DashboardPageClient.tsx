            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden sm:inline text-gray-700 max-w-[200px] truncate" title={profileDisplayName.trim() || user?.displayName || user?.email || undefined}>
                  ...
                  <div className="bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 border-2 border-green-300 rounded-2xl p-8 shadow-lg">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                      {isDoctor ? (
                        ...
                        <>
                          <p className="text-xl font-bold text-gray-900 mb-3">Olasılık düzeyi</p>
